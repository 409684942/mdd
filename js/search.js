(function ($) {
	...
	Search.DEFAULTS={
		autocomplete:false,
		url:'https://suggest.taobao.com/sug?code=utf-8&_ksTS=1578282976333_841&callback=jsonp842&k=1&area=c2c&bucketid=3&q=',
		css3:false,
		js:false,
		animation:'fade',
		getDataInterval: 200
...
// 		var url = 'https://suggest.taobao.com/sug?code=utf-8&_ksTS=1578282976333_841&callback=jsonp842&k=1&area=c2c&bucketid=3&q='+encodeURIComponent($.trim($input.val()));
// 		$.ajax({
// 			url: url,
// 			dataType: 'jsonp'
// 		}).done(function (data) {
